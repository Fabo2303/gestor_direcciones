...
public class AddImageWindow {
	...
	private void initLabels() {
		...
		JLabel text2 = new JLabel("IMAGEN");
		...
		guardarBtn.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (!nombre.isEmpty() && !descripcion.isEmpty() && !url.isEmpty() && !idProy.isEmpty()) {
					...
					Image i1 = new Image(0, nombre, descripcion, Integer.parseInt(idProy), 0, url, 1);
